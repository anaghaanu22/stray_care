...
class VetinaryDept extends StatefulWidget {
  const VetinaryDept({super.key});

  @override
  State<VetinaryDept> createState() => _VetinaryDeptState();
}

class _VetinaryDeptState extends State<VetinaryDept> {
  @override
      ...
      body: SafeArea(
        ...
        Column(
          ...
          Container(
            ...
            InkWell(
  onTap: () {
    Navigator.push(context, MaterialPageRoute(builder:(context)=>LogVet()));
  },
  child: Container(
