...
import 'package:stray_care/police.dart/log.dart';



class PoliceDept extends StatefulWidget {
  const PoliceDept({super.key});

  @override
  State<PoliceDept> createState() => _PoliceDeptState();
}

class _PoliceDeptState extends State<PoliceDept> {
  @override
      ...
      body: SafeArea(
        ...
        Column(
          ...
          Container(
            ...
            InkWell(
  onTap: () {
    Navigator.push(context, MaterialPageRoute(builder:(context)=>LogPolice()));
  },
  child: Container(
