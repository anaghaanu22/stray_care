...
class LogStray extends StatefulWidget {
  const LogStray({Key? key}) : super(key: key);

  @override
  State<LogStray> createState() => _LogStrayState();
}

class _LogStrayState extends State<LogStray> {
